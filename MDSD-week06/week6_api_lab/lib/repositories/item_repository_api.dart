  ...
  Future<List<Item>> getItems() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        // แปลงข้อมูล List ของ JSON เป็น List<Item> ด้วย .map().toList()
      ...
      // ดักจับกรณี JSON ที่ได้รับจากเซิร์ฟเวอร์ผิดรูปแบบ
      throw Exception('รูปแบบข้อมูล JSON จากเซิร์ฟเวอร์ไม่ถูกต้อง');
    } catch (e) {
      if (e is Exception) {
        rethrow;
      }
